...
// exists checks if client with this IP address already exists and returns the
// source which updated it last.
func (clients *clientsContainer) exists(ip netip.Addr) (src clientSource) {
	clients.lock.Lock()
	defer clients.lock.Unlock()
